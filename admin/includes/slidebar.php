...
if($roleId==1){
    ...
    <li>
    <a href='index.php?controller=thanh-vien&action=them-thanh-vien'><i class='fa fa-hand-o-right' aria-hidden='true'></i>Thêm thành viên mới</a>
    </li>
    <li>
