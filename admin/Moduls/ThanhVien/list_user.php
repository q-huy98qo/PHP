                 ...
                 <tbody>
                  ...
                  foreach($data as $dt){
                    ...
                    <tr>
                      ...
                      <td><a href="index.php?controller=thanh-vien&action=sua-thanh-vien&id=<?php echo $dt['id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                      <td><a href="index.php?controller=thanh-vien&action=xoa-thanh-vien&id=<?php echo $dt['id']; ?>"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                    </tr>
                    <?php
                    $stt++;
                  }
