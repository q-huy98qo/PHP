        ...
        <div class="row">
            <div class="col-12">
                <form action="" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <img class="img-fluid img-circle img-product" src="<?php echo $data_sanpham['hinhanh']; ?>" alt="hinhanh">
                            <?php
                ...
                <div class="col-md-12">
                    ...
                    <button type="submit" name="submit" class="btn">Cập nhật sản phẩm</button>
                </form>
