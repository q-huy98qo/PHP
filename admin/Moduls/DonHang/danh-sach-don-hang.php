                     ...
                     <tbody>
                      ...
                      if($dataDonHang!=0){
                        ...
                        foreach($dataDonHang as $valueOrder){
                          ...
                          $dataDonHang = $db->ThongTinDonHangOrder($MaDDH);
                          ...
                          <tr>
                            ...
                            <td><?php if($dataDonHang['DaThanhToan']==null && $dataDonHang['DaHuy']==null) {echo "<span style='color: green'><i class='fa fa-refresh fa-spin'></i> Đang xử lý</span>"; }
                            else if($dataDonHang['DaThanhToan']!=null && $dataDonHang['DaHuy']==null){echo "<span style='color: green'>Đã thanh toán</span>";}else if($dataDonHang['DaHuy']!=null && $dataDonHang['DaThanhToan']==null){echo "<span style='color: green'> Đã hủy hóa đơn</span>";}?></td>
                            <td>
                              <span>
                                <a href="index.php?controller=don-hang&action=chi-tiet-don-hang&MaDDH=<?php echo $valueOrder['MaDDH']; ?>" title="Xem chi tiết"><i class="fa fa-eye btn btn-xs btn-info"></i></a>
                              </span>
                            </td>
                          </tr>
