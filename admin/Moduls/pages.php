<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="index.php?controller=don-hang">Quản lý đơn hàng</a>
            </li>
            <li class="breadcrumb-item">
                       ...
                       <tbody>
                        ...
                        foreach($dataDonHang as $valueOrder){
                            ...
                            <tr>
                                ...
                                <td><?php if($dataDonHang['DaThanhToan']==null && $dataDonHang['DaHuy']==null) {echo "<span style='color: green'><i class='fa fa-refresh fa-spin'></i> Đang xử lý</span>"; }else if($dataDonHang['DaThanhToan']!=null && $dataDonHang['DaHuy']==null){echo "<span style='color: green'>Đã thanh toán</span>";}else if($dataDonHang['DaHuy']!=null && $dataDonHang['DaThanhToan']==null){echo "<span style='color: green'> Đã hủy hóa đơn</span>";}?></td>
                                <td>
                                    <span>
